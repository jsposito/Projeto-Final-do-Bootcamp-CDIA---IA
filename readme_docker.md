...
### Arquivos Principais
- `main.py` - Script Python principal com classe ManutencaoPreditiva
...
- `docker-compose-full.yml` - Versão completa com API
...
1. **Setup rápido com script automatizado:**
```bash
...
### Execução - Múltiplas Opções

#### 🎯 Opção 1: Makefile (Mais Fácil)
```bash
